...
export const metadata = {
  title: "Hiring · Higgins Electric",
  description:
    "Looking for work as an electrician in Connecticut? Higgins Electric hires journeymen, apprentices, generator techs, and diesel mechanics. Apply here.",
};
    ...
    <>
      <section className="relative flex min-h-[80svh] items-center overflow-hidden bg-higgins-black pt-32 pb-24 md:pt-40 md:pb-32">
        ...
        <div className="container-edge relative flex w-full flex-col items-center text-center">
          ...
          <h1 className="mx-auto max-w-[18ch] font-display text-fluid-3xl leading-[0.9] tracking-[0.01em] text-higgins-bone">
            <GSAPTextReveal as="span" split="words" trigger="mount">
              Looking for work? Let&apos;s talk.
            </GSAPTextReveal>
          </h1>
          <p className="mx-auto mt-8 max-w-xl text-fluid-lg leading-relaxed text-higgins-concrete">
            We hire on character first. License second. If you have both we are already interested.
          </p>
        </div>
      </section>
      ...
      <section className="bg-higgins-graphite py-24 md:py-32">
        <div className="container-edge">
          <div className="mb-12 flex flex-wrap items-end justify-between gap-6">
            <h2 className="font-display text-fluid-2xl tracking-[0.005em] text-higgins-bone">
        ...
        <div className="container-edge">
          <div className="grid gap-10 md:grid-cols-12">
            <div className="md:col-span-5">
              ...
              <h2 className="font-display text-fluid-2xl leading-[0.95] tracking-[0.005em]">
                Send your info.
                <br />
            ...
            <form
              ...
              {...getFormAction("Higgins Electric — employment application")}
            >
              <input type="hidden" name="source" value="hiring" />
